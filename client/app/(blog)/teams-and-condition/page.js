  ...
  return (
    <div className="postContent page max-w-7xl mx-auto px-2 py-2 pages">
      <Head
        ...
        metaDescription={`Terms and Conditions for ${process.env.NEXT_PUBLIC_MAIN_DOMAIN}`}
      />
      <h2>
        <strong>Terms and Conditions</strong>
      </h2>

      <p>Welcome to newbiecoding!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of newbiecoding's Website, located at https://newbiecoding.com/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use newbiecoding if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing newbiecoding, you agreed to
        use cookies in agreement with the newbiecoding's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, newbiecoding and/or its licensors own the
        intellectual property rights for all material on newbiecoding. All
        intellectual property rights are reserved. You may access this from
        newbiecoding for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from newbiecoding</li>
        <li>Sell, rent or sub-license material from newbiecoding</li>
        <li>Reproduce, duplicate or copy material from newbiecoding</li>
        <li>Redistribute content from newbiecoding</li>
      </ul>
      ...
      <p>
        ...
        newbiecoding does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of newbiecoding,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, newbiecoding shall not be
      ...
      <p>
        newbiecoding reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant newbiecoding a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of newbiecoding; and (d) the link
      ...
      <p>
        ...
        e-mail to newbiecoding. Please include your name, your organization
      ...
      <p>
        No use of newbiecoding's logo or other artwork will be allowed for
